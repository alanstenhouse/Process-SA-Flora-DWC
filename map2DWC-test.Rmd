...
```{r}
tData %<>% select(-c(sightingdate,isindigenousflag,amgzone,spreliabcode,numobserved))
...
## export as CSV
We could do this better but good enough for now - saving output in default path.
```{r}
